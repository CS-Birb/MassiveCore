...
public class AdapterItemStack implements JsonDeserializer<ItemStack>, JsonSerializer<ItemStack>
{
	...
	public static void convertTypeIdToString(JsonElement jsonElement)
	{
		...
		String name = intIdToString(typeId);
		JsonElement newValue = new JsonPrimitive(name);
		json.add("id", newValue);
	}
	
	public static String intIdToString(int id)
	{
		switch (id)
		{
			case 0: return "AIR";
			...
			case 188: return "SPRUCE_FENCE";
			case 189: return "BIRCH_FENCE";
			case 190: return "JUNGLE_FENCE";
			case 191: return "DARK_OAK_FENCE";
			case 192: return "ACACIA_FENCE";
			...
			case 198: return "END_ROD";
			case 199: return "CHORUS_PLANT";
			case 200: return "CHORUS_FLOWER";
			case 201: return "PURPUR_BLOCK";
			case 202: return "PURPUR_PILLAR";
			case 203: return "PURPUR_STAIRS";
			case 204: return "PURPUR_DOUBLE_SLAB";
			case 205: return "PURPUR_SLAB";
			case 206: return "END_BRICKS";
			case 207: return "BEETROOT_BLOCK";
			case 208: return "GRASS_PATH";
			case 209: return "END_GATEWAY";
			case 210: return "COMMAND_REPEATING";
			case 211: return "COMMAND_CHAIN";
			...
			case 218: return "OBSERVER";
			case 219: return "WHITE_SHULKER_BOX";
			case 220: return "ORANGE_SHULKER_BOX";
			case 221: return "MAGENTA_SHULKER_BOX";
			case 222: return "LIGHT_BLUE_SHULKER_BOX";
			case 223: return "YELLOW_SHULKER_BOX";
			case 224: return "LIME_SHULKER_BOX";
			case 225: return "PINK_SHULKER_BOX";
			case 226: return "GRAY_SHULKER_BOX";
			case 227: return "SILVER_SHULKER_BOX";
			case 228: return "CYAN_SHULKER_BOX";
			case 229: return "PURPLE_SHULKER_BOX";
			case 230: return "BLUE_SHULKER_BOX";
			case 231: return "BROWN_SHULKER_BOX";
			case 232: return "GREEN_SHULKER_BOX";
			case 233: return "RED_SHULKER_BOX";
			case 234: return "BLACK_SHULKER_BOX";
			case 235: return "WHITE_GLAZED_TERRACOTTA";
			case 236: return "ORANGE_GLAZED_TERRACOTTA";
			case 237: return "MAGENTA_GLAZED_TERRACOTTA";
			case 238: return "LIGHT_BLUE_GLAZED_TERRACOTTA";
			case 239: return "YELLOW_GLAZED_TERRACOTTA";
			case 240: return "LIME_GLAZED_TERRACOTTA";
			case 241: return "PINK_GLAZED_TERRACOTTA";
			case 242: return "GRAY_GLAZED_TERRACOTTA";
			case 243: return "SILVER_GLAZED_TERRACOTTA";
			case 244: return "CYAN_GLAZED_TERRACOTTA";
			case 245: return "PURPLE_GLAZED_TERRACOTTA";
			case 246: return "BLUE_GLAZED_TERRACOTTA";
			case 247: return "BROWN_GLAZED_TERRACOTTA";
			case 248: return "GREEN_GLAZED_TERRACOTTA";
			case 249: return "RED_GLAZED_TERRACOTTA";
			case 250: return "BLACK_GLAZED_TERRACOTTA";
			case 251: return "CONCRETE";
			case 252: return "CONCRETE_POWDER";
			case 255: return "STRUCTURE_BLOCK";
			...
			case 409: return "PRISMARINE_SHARD";
			case 410: return "PRISMARINE_CRYSTALS";
			case 411: return "RABBIT";
			case 412: return "COOKED_RABBIT";
			case 413: return "RABBIT_STEW";
			case 414: return "RABBIT_FOOT";
			case 415: return "RABBIT_HIDE";
			case 416: return "ARMOR_STAND";
			...
			case 423: return "MUTTON";
			case 424: return "COOKED_MUTTON";
			case 425: return "BANNER";
			case 426: return "END_CRYSTAL";
			case 427: return "SPRUCE_DOOR_ITEM";
			case 428: return "BIRCH_DOOR_ITEM";
			case 429: return "JUNGLE_DOOR_ITEM";
			case 430: return "ACACIA_DOOR_ITEM";
			case 431: return "DARK_OAK_DOOR_ITEM";
			case 432: return "CHORUS_FRUIT";
			case 433: return "CHORUS_FRUIT_POPPED";
			case 434: return "BEETROOT";
			case 435: return "BEETROOT_SEEDS";
			case 436: return "BEETROOT_SOUP";
			case 437: return "DRAGONS_BREATH";
			case 438: return "SPLASH_POTION";
			case 439: return "SPECTRAL_ARROW";
			case 440: return "TIPPED_ARROW";
			case 441: return "LINGERING_POTION";
			case 442: return "SHIELD";
			case 443: return "ELYTRA";
			case 444: return "BOAT_SPRUCE";
			case 445: return "BOAT_BIRCH";
			case 446: return "BOAT_JUNGLE";
			case 447: return "BOAT_ACACIA";
			case 448: return "BOAT_DARK_OAK";
			case 449: return "TOTEM";
			case 450: return "SHULKER_SHELL";
			case 452: return "IRON_NUGGET";
			case 453: return "KNOWLEDGE_BOOK";
			...
			default: throw new RuntimeException(String.valueOf(id));
		}
	}
